...
CREATE INDEX IDX_PIA_FASE_3 ON PIANIFICAZIONE_FASE(IDPRDFASEPADRE);
  ...
  CREATE TABLE PIANIFICAZIONE_LOG
   (	IDLOG NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY, 
    DATA DATE NULL,
   APPLICAZIONE VARCHAR2(30 BYTE) NOT NULL ,
  ...
  LIVELLO NUMBER NULL,
  DURATA NUMBER NULL,
  DURATA_COMULATIVA NUMBER NULL,
  OC VARCHAR2(1),
  QTA_ACCANTONATA FLOAT NULL,
  QTA_LAVORATA FLOAT NULL,
  IDPRDFASERIPARTENZA VARCHAR2(25 BYTE), 
  DATAACCANTONATO DATE NULL,
	 PRIMARY KEY (IDCC)
   ) ;
   
   CREATE INDEX IDX_PCC_1 ON PIAN_CATENA_COMMESSA(IDPRDFASE);
   
   
    CREATE TABLE PIANIFICAZIONE_RUNTIME
   (	
   IDODL NUMBER NOT NULL, 
  "IDLANCIOD" VARCHAR2(25 BYTE), 
  "IDPRDFASE" VARCHAR2(25 BYTE), 
